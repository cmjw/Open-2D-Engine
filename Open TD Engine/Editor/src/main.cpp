...
int main() {
    ...
    // Create a window that fills the screen except for the taskbar
    sf::RenderWindow window(sf::VideoMode(desktopMode.width, desktopMode.height), "Game Editor", sf::Style::Default);
